           ...
           {signup && showOtp && (
            <div>
              <div className='content'>
                <h1 style={{display:"flex",justifyContent:'center'}}>Otp send to </h1>
                <p style={{display:"flex",justifyContent:'center'}}>{phone}</p>
              </div>
              <h3 style={ { display: "flex", justifyContent: 'center' } }>Enter otp</h3>
              ...
              <div style={{justifyContent:"center",display:'flex',marginTop:'30px'}}>
                <button className='btn btn-dark' style={{marginRight:'20px'}} onClick={otpVerify}>
                  Verify
                </button>
                <div>
                  <button
                ...
                <fieldset>
                  ...
                  <div className='d-md-none d-block mb-4'>
                    <select className='form-select' required>
                      <option value='Student' onChange={()=> setUser('Student')}>Student</option>
                      <option value='Professional' onChange={()=> setUser('Professional')}>Professional</option>
                      <option value='Entrepreneur' onChange={()=> setUser('Entrepreneur')}>Entrepreneur</option>
                    </select>
                  </div>
                  <div className='row'>
