...
const FindMentorSection = () =>
{
  ...
  return (
   <>{loading? (<h1>Loading...</h1>): <div className='find-mentor py-sm-5'>
      <div className='container-xxl px-xxl-0 px-lg-5 px-md-4 px-sm-3'>
        <div className='row'>
          ...
          <div className='col-md-8 mentor-card-section'>
            <img className='find-mentor-bg' src='/images/dots-1.png' alt='' />
            <div className='mentor-cards row px-xl-5 pt-xxl-5 pt-xl-4 pt-lg-5 pt-md-5'>
              ...
              >
                { mentor[0] && mentor[0].data.slice(0,5).map( ( mentor, index ) =>
                {
                  return (
